...
namespace UwpUaf.Asm.Shared
{
    class HelloAuthenticator : IAuthenticator, IOnConfirmationHandler
    {
        ...
        static HelloAuthenticator instance;
        TaskCompletionSource<bool> promise;
        KeyCredential userCredential;
        string _keyId;
        ...
        {
            return await userCredential.SignAsync(challenge);
        }
    }
}
